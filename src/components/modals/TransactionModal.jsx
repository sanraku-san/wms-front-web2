            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-6 pt-4 border-t">
              <div className="flex justify-between align">
                <span class="flex items-center justify-between">
                  ...
                  <span class="px-3 py-1 text-base font-semibold rounded-full /* Dynamic classes based on status */"></span>
                </span>
                <span
                  className={`px-2 py-1 text-lg font-bold rounded-full ${
                    selectedOrder.status_id === 0
                      ? "bg-red-100 text-red-800"
                      : "bg-green-100 text-green-800"
                  }`}
                >
                  {selectedOrder.status_id?.name ||
                    (selectedOrder.status_id === 0 ? "Pending" : "Delivered")}
                </span>
              </div>
