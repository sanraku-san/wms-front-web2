...
function AppLayout({ sidebarOpen, toggleSidebar, setIsLoggedIn }) {
  ...
  // Navigation items
      ...
      const transactionItems = [
        ...
        { name: 'Transaction History', icon: <FaHistory />, path: '/transactionHistory' },
      ];

      const reportItems = [
        { name: 'Inventory Report', icon: <FaChartPie />, path: '/reports/inventory' },
        { name: 'Delivery Report', icon: <FaChartPie />, path: '/reports/delivery' },
